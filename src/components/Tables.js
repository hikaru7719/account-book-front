...
export default class Tables extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <Grid container justify="center" className="cardContainer" style={{flexGrow: 1, margin: '32px auto'}}
                      spacing={16}>
                    <Grid item xs={8}>
                        <Button variant="contained" color="primary" onClick={() => this.props.onClick("/input")}>Add
                            Spend</Button>
                        <Card>
                            <Table>
                                <TableHead>
